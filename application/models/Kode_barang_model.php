...
{
    var $table = 'kode_barang';
    var $column_order = array(null, 'kode_barang_gol','kode_barang_bidang', 'kode_barang_kelompok', 'kode_barang_sub_kelompok', 'kode_barang_sub2_kelompok', 'kode_barang_ket');
    var $column_search = array('kode_barang_gol','kode_barang_bidang', 'kode_barang_kelompok', 'kode_barang_sub_kelompok', 'kode_barang_sub2_kelompok', 'kode_barang_ket');
    var $order = array('kode_barang_id' => 'asc');
