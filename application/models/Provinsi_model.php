...
{
    var $table = 'kode_provinsi';
    var $column_order = array(null, 'provinsi_kode','provinsi_ket');
    var $column_search = array('provinsi_kode', 'provinsi_ket');
    var $order = array('provinsi_id' => 'desc');
