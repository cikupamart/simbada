...
{
    var $table = 'kode_sub_unit';
    var $column_order = array(null, 'sub_unit_kode','sub_unit_ket', 'unit_ket', 'bidang_ket');
    var $column_search = array('sub_unit_kode', 'sub_unit_ket', 'unit_ket', 'bidang_ket');
    var $order = array('sub_unit_id' => 'desc');
