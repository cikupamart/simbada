...
class Satuan_barang_model extends CI_Model
{
    ...
    var $column_order = array(null, 'satuan_barang_kode','satuan_barang_ket');
    var $column_search = array('satuan_barang_kode', 'satuan_barang_ket');
    var $order = array('satuan_barang_id' => 'desc');
