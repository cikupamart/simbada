...
class Asal_usul_model extends CI_Model
{
    var $table = 'asal_usul';
    var $column_order = array(null, 'satuan_barang_ket');
    var $column_search = array('satuan_barang_ket');
    var $order = array('asal_usul_id' => 'desc');
