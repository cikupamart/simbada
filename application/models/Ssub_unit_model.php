...
class Ssub_unit_model extends CI_Model
{
    var $table = 'kode_ssub_unit';
    var $column_order = array(null, 'ssub_unit_kode','ssub_unit_ket', 'sub_unit_ket', 'unit_ket', 'bidang_ket');
    var $column_search = array('ssub_unit_kode', 'ssub_unit_ket', 'sub_unit_ket', 'unit_ket', 'bidang_ket');
    var $order = array('ssub_unit_id' => 'desc');
