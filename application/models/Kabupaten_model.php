...
{
    var $table = 'kode_kabupaten';
    var $column_order = array(null, 'kabupaten_kode','kabupaten_ket', 'provinsi_ket');
    var $column_search = array('kabupaten_kode', 'kabupaten_ket', 'provinsi_ket');
    var $order = array('kabupaten_id' => 'desc');
